...
class InvestmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investment" do
    assert_difference('Investment.count') do
      post investments_url, params: { investment: { feature_id: @investment.feature_id, investment: @investment.investment, team_id: @investment.team_id } }
    end
  ...
  test "should update investment" do
    patch investment_url(@investment), params: { investment: { feature_id: @investment.feature_id, investment: @investment.investment, team_id: @investment.team_id } }
